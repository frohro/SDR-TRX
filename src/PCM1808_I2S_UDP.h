...
extern const int MCLK_MULT; // 384 for 48 BCK per frame,  256 for 64 BCK per frame
...
#define QUEUE_SIZE 49 // Maximum latency is 8 packets, which is 15 ms.  Average is 2 packets, or 4 ms.
